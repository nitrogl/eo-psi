...
typedef enum EOPSIMessageType {
  ...
  , EOPSI_MESSAGE_CLIENT_COMPUTATION_REQUEST  ///< Client outsources computation to another client
  , EOPSI_MESSAGE_CLOUD_COMPUTATION_REQUEST   ///< Client outsources computation to server
  ...
  , EOPSI_MESSAGE_UNKNOWN                     ///< Unknown message type (default)
} EOPSIMessageType;
//-----------------------------------------------------------------------------
