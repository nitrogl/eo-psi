...
void MurmurHash3::murmurHash3_x86_32 (const void * key, int len, void * out) {
...
void MurmurHash3::murmurHash3_x86_128 (const void * key, const int len, void * out) {
  const uint8_t * data = (const uint8_t*)key;
...
void MurmurHash3::murmurHash3_x64_128 (const void * key, const int len, void * out) {
  const uint8_t * data = (const uint8_t*)key;
  const int nblocks = len / 16;
...
MurmurHash3::MurmurHash3() {
  srand(time(NULL));
  seed = rand() % __UINT32_MAX__;
}
//-----------------------------------------------------------------------------

MurmurHash3::MurmurHash3(uint32_t seed) {
  this->seed = seed;
}
//-----------------------------------------------------------------------------
